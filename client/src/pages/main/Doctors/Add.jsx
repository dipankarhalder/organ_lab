...
import { doctorServices, specialServices } from "../../../services/endpoints";
...
export const DoctorAdd = ({ isClosing, onClose, onSuccess }) => {
  ...
  const onSubmit = async (data) => {
    setFormLoading(true);
    try {
      const res = await postServices(`${doctorServices}/new`, data);
      const isError = await handleApiErrorToast(res, addToast, toastStatus);
      if (isError) {
        return;
      }
